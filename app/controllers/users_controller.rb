class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit( :name, :email, :password, :password_digest, :avatar, :gender_id, :birth_date, :address, :city_id, :state_id, :position_id, :branch_id, :active )
    end
    ...
    def signed_in_user
      flash[:info] = "Logue-se antes de utilizar o sistema."
